...
import com.itcast.dictionary.Models.Phonetics;
import com.itcast.dictionary.R;
import com.itcast.dictionary.ViewHolders.PhoneticViewHolder;
...
//                    player.setAudioStreamType(AudioManager.STREAM_MUSIC);
                    ...
                    e.printStackTrace();
                    Toast.makeText(context,"不能播放声音！",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
